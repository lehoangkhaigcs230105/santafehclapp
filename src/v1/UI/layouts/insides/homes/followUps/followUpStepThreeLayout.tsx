import styles from "src/assets/styles/tabStyles/homeStyles/followUpStyles/followUpStepThree.styles";
...
const FollowUpStepThreeLayout = () => {
  ...
  useEffect(() => {
    const loadPrefill = async () => {
      try {
        ...
        console.error("Follow up step 3 prefill error:", error);
      }
    };
  ...
  const pushToNext = () => {
    ...
    navigation.navigate(StackScreens.followUpFinalStep);
  };

  return (
    <View style={styles.container}>
      <HeaderTabs title="Follow Up Step 3" showBack />
        ...
        <View style={styles.form}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.helperText}>
              Complete the driver profile details that belong to this follow up request.
            </Text>
          </View>
...
export default FollowUpStepThreeLayout;
