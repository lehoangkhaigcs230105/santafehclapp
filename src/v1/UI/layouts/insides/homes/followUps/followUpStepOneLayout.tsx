...
const FollowUpStepOneLayout = () => {
  ...
  const pushToNext = () => {
    ...
    navigation.navigate(StackScreens.followUpStepTwo, {
  ...
  return (
    <View style={styles.container}>
      <HeaderTabs title="Follow Up Step 1" showBack />
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.form}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.sectionTitle}>Follow Up Basics</Text>
          ...
          <View style={styles.formCard}>
            <FormInput placeholder={t('status_follow_up')} value={status} onChangeText={setStatus} />
...
export default FollowUpStepOneLayout;
