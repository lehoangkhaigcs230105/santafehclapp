import styles from "src/assets/styles/tabStyles/homeStyles/followUpStyles/followUpStepTwo.styles";
...
const FollowUpStepTwoLayout = () => {
  ...
  const pushToNext = () => {
    ...
    navigation.navigate(StackScreens.followUpStepThree);
  };

  return (
    <View style={styles.container}>
      <HeaderTabs title="Follow Up Step 2" showBack />
...
export default FollowUpStepTwoLayout;
