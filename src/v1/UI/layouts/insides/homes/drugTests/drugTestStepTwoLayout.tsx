import styles from "src/assets/styles/tabStyles/homeStyles/drugTestStyles/drugTestStepTwo.styles";
...
const DrugTestStepTwoLayout = () => {
  ...
  const pushToNext = () => {
    ...
    navigation.navigate(StackScreens.drugTestStepThree);
  };

  return (
    <View style={styles.container}>
      <HeaderTabs title="Drug Test Step 2" showBack />
...
export default DrugTestStepTwoLayout;
