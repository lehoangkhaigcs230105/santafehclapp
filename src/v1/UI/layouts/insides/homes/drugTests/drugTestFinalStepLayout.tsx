import styles from "src/assets/styles/tabStyles/homeStyles/drugTestStyles/drugTestFinalStep.styles";
...
const DrugTestFinalStepLayout = () => {
  ...
  return (
    <View style={styles.container}>
      <HeaderTabs title="Drug Test Final Step" showBack />
        ...
        <View style={styles.form}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.helperText}>
              Finish the drug test packet with signatures and any optional supporting files.
            </Text>
          </View>
...
export default DrugTestFinalStepLayout;
