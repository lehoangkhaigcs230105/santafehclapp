import styles from "src/assets/styles/tabStyles/homeStyles/returnDutyStyles/returnDutyFinalStep.styles";
...
const ReturnDutyFinalStepLayout = () => {
  ...
  return (
    <View style={styles.container}>
      <HeaderTabs title="Return Of Duty Final Step" showBack />
...
export default ReturnDutyFinalStepLayout;
