import styles from "src/assets/styles/tabStyles/homeStyles/renewStyles/renewStepThree.styles";
  ...
  useEffect(() => {
    const loadPrefill = async () => {
      try {
        ...
        console.error("Renew step 3 prefill error:", error);
      }
    };
        ...
        <View style={styles.form}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.helperText}>
              Complete the driver profile details that belong to this renewal request.
            </Text>
          </View>
          ...
          <View style={styles.formCard}>
            ...
            <ButtonForm onPress={pushToRenewFinalStep} text={t("next")} />
          </View>
        </View>
      </ScrollView>
    </View>
...
export default RenewStepThreeLayout;
