import styles from "src/assets/styles/tabStyles/homeStyles/postAccidentStyles/postAccidentStepOne.styles";
...
const PostAccidentStepOneLayout = () => {
  ...
  useEffect(() => {
    const loadPrefill = async () => {
      try {
        ...
        console.error("Post-accident step 1 prefill error:", error);
      }
    };
  ...
  const pushToNext = () => {
    ...
    navigation.navigate(StackScreens.postAccidentStepTwo, {
  ...
  return (
    <View style={styles.container}>
      <HeaderTabs title="Post Accident Step 1" showBack />
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.form}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.sectionTitle}>Post Accident Basics</Text>
          ...
          <View style={styles.formCard}>
            <FormInput placeholder={t('status_post_accident')} value={status} onChangeText={setStatus} />
...
export default PostAccidentStepOneLayout;
