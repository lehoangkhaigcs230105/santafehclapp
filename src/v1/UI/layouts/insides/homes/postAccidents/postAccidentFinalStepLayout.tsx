import styles from "src/assets/styles/tabStyles/homeStyles/postAccidentStyles/postAccidentFinalStep.styles";
...
const PostAccidentFinalStepLayout = () => {
  ...
  return (
    <View style={styles.container}>
      <HeaderTabs title="Post Accident Final Step" showBack />
        ...
        <View style={styles.form}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.helperText}>
              Finish the post accident packet with signatures and any optional supporting files.
            </Text>
          </View>
...
export default PostAccidentFinalStepLayout;
