import styles from "src/assets/styles/tabStyles/homeStyles/postAccidentStyles/postAccidentStepThree.styles";
...
const PostAccidentStepThreeLayout = () => {
  ...
  useEffect(() => {
    const loadPrefill = async () => {
      try {
        ...
        console.error("Post accident step 3 prefill error:", error);
      }
    };
  ...
  const pushToNext = () => {
    ...
    navigation.navigate(StackScreens.postAccidentFinalStep);
  };

  return (
    <View style={styles.container}>
      <HeaderTabs title="Post Accident Step 3" showBack />
        ...
        <View style={styles.form}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.helperText}>
              Complete the driver profile details that belong to this post accident request.
            </Text>
          </View>
...
export default PostAccidentStepThreeLayout;
